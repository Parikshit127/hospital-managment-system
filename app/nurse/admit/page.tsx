...
export default function NurseAdmitPatientPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (result.success && result.data) {
      // Nurses can't open /reception/ipd/{id}; send them back to their patient list.
  ...
  return (
    <AppShell pageTitle="Admit Patient" pageIcon={<Bed className="h-5 w-5" />}>
