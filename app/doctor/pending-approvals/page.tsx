 ...
 * Doctor sees all EMR entries pending their approval.
 * Shows typed_by (coordinator) vs signed_by (doctor) clearly.
 */

import React, { useState, useEffect } from 'react';
import { CheckCircle, XCircle, Clock, User, FileText, Loader2, AlertCircle } from 'lucide-react';
                                ...
                                <div className="flex items-start justify-between">
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2 mt-1 text-xs text-gray-500">
                                            ...
                                            <span>Entered by coordinator: <strong>{enc.typed_by}</strong></span>
                                            <span>·</span>
