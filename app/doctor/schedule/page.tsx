        ...
        <div className="p-4 md:p-8 max-w-[1400px] mx-auto w-full space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            {[
              ...
              <div
                key={i}
                className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm hover:border-teal-500/20 transition-all"
              >
                    ...
                    {filteredAppointments.map((appointment) => {
                      ...
                      return (
                        <div
                          ...
                          className="p-5 hover:bg-teal-50/50 transition-all group flex flex-col sm:flex-row gap-4 items-start sm:items-center"
                        ...
                        >
                          ...
                          <div className="flex-shrink-0 w-28">
                            ...
                            <div className="text-xs font-bold text-teal-500/70">
                              Scheduled
                            </div>
                          </div>
                          ...
                          <div className="mt-4 sm:mt-0">
                            <button
                              ...
                              className="p-2 text-gray-400 hover:text-teal-500 hover:bg-teal-500/10 rounded-xl transition-all border border-transparent hover:border-teal-500/20"
                            >
          ...
          <div className="relative bg-white rounded-2xl shadow-xl border border-gray-200 w-full max-w-lg overflow-hidden">
            ...
            <div className="p-6 space-y-5">
              ...
              <div className="pt-1 flex justify-end">
                <button
                  onClick={() => setShowPatientModal(false)}
                  className="px-5 py-2.5 bg-teal-600 text-white text-sm font-bold rounded-xl hover:bg-teal-500 transition"
                >
                  Close
                </button>
              </div>
