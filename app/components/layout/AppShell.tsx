...
export function AppShell({ children, pageTitle, pageIcon, headerActions, onRefresh, refreshing }: AppShellProps) {
                    ...
                    <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-gray-200 px-6 py-3">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3 pl-10 lg:pl-0">
                                ...
                                <div>
                                    <h1 className="text-lg font-black text-gray-900">{pageTitle}</h1>
                                </div>
                            </div>
