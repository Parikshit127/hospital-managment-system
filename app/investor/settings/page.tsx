        ...
        <div className="max-w-5xl mx-auto space-y-8 pb-12 print:hidden">
            <div className="flex items-center gap-3">
                <Link
                    ...
                    className="p-2 bg-white border border-[#ede9e2] hover:bg-[#faf9f6] text-[#0a1e42] rounded-xl transition-all cursor-pointer"
                    title="Back to Dashboard"
                >
                    <ArrowLeft className="w-4 h-4" />
                </Link>
                <div>
                    <h1 className="text-lg font-black text-[#0a1e42]">Portal Access Settings</h1>
                    <p className="text-xs text-slate-500 font-medium">Manage investor logins and 24h temporary access keys</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-2xl border border-[#ede9e2] shadow-sm flex flex-col justify-between">
                    <div>
            ...
            <div className="bg-white rounded-2xl border border-[#ede9e2] shadow-sm overflow-hidden">
                <div className="bg-[#faf9f6] border-b border-[#ede9e2] p-6 flex items-center justify-between">
                    <div>
                        <h2 className="text-lg font-black text-[#0a1e42]">Active & Historical Investor Credentials</h2>
                        <p className="text-xs font-bold text-gray-500 uppercase tracking-widest mt-1">Credentials Stored in Database</p>
                    </div>
                    <button
                        onClick={loadCredentials}
                        className="p-2 bg-white border border-[#ede9e2] hover:bg-gray-50 text-gray-700 rounded-xl transition-all cursor-pointer"
                        title="Refresh List"
                    >
