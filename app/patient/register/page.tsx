 ...
 * Patient can register themselves and get into the database
 */
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-50 flex items-center justify-center p-4">
                <div className="bg-white rounded-3xl shadow-xl p-10 max-w-md w-full text-center space-y-5">
                    ...
                    <p className="text-gray-500 text-sm">Your account has been created.</p>
                    <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-5">
                        ...
                        <p className="text-xs text-gray-500 mt-2">Save this ID — you'll need it to log in</p>
                    </div>
                    {success.setup_link && (
                ...
                <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
                    ...
                    <form onSubmit={handleSubmit} className="p-8 space-y-5">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <select value={selectedOrg} onChange={e => setSelectedOrg(e.target.value)}
                                    ...
                                    {orgs.map(o => (
                                        <option key={o.id} value={o.slug}>{o.name}{o.address ? ` — ${o.address}` : ''}</option>
                                    ))}
                                </select>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input value={form.age} onChange={e => setForm(f => ({ ...f, age: e.target.value }))}
                                    placeholder="Age in years" type="number" min="0" max="120" className={inputCls} />
                            </div>
                            <div>
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input value={form.address} onChange={e => setForm(f => ({ ...f, address: e.target.value }))}
                                        placeholder="Your address" className={`${inputCls} pl-10`} />
                                </div>
                            </div>
                            <div>
                        ...
                        <p className="text-center text-sm text-gray-500">
                            ...
                            <Link href="/patient/login" className="text-emerald-600 font-bold hover:underline">Sign In</Link>
                        </p>
                    </form>
                </div>
            </div>
...
export default function PatientRegisterPage() {
    return <Suspense fallback={<div className="min-h-screen flex items-center justify-center"><Loader2 className="w-6 h-6 animate-spin text-emerald-500" /></div>}><RegisterForm /></Suspense>;
}
