...
<body>
    ...
    <div style="max-width:700px;margin:0 auto;padding:30px;position:relative;z-index:1;">
        <!-- Header -->
        <div style="display:flex;justify-content:space-between;align-items:flex-start;border-bottom:3px solid #1e3a6e;padding-bottom:14px;margin-bottom:18px;">
            <div>
                <h1 style="font-size:24px;font-weight:900;color:#1e3a6e;letter-spacing:-1px;">${hospitalName}</h1>
                <p style="font-size:10px;color:#6b7280;margin-top:2px;">A Unit of TAH Global Healthcare Pvt. Ltd.</p>
            </div>
            <div style="text-align:right;">
                <h2 style="font-size:18px;font-weight:800;color:${isFinal ? '#1e3a6e' : '#f97316'};">${isFinal ? 'SUMMARY BILL' : 'INTERIM SUMMARY'}</h2>
                <p style="font-size:11px;font-weight:700;color:#1e3a6e;">${invoice.invoice_number}</p>
        ...
        <h3 style="font-size:11px;font-weight:800;color:#6b7280;text-transform:uppercase;letter-spacing:1.5px;margin-bottom:6px;">Charges Summary</h3>
        <table style="width:100%;border-collapse:collapse;margin-bottom:14px;border:1px solid #e5e7eb;border-radius:6px;overflow:hidden;">
            <thead>
                <tr style="background:#f3f4f6;">
                    <th style="padding:8px 12px;text-align:left;font-size:10px;font-weight:800;color:#6b7280;">Category</th>
                    <th style="padding:8px 12px;text-align:center;font-size:10px;font-weight:800;color:#6b7280;">Items</th>
                    <th style="padding:8px 12px;text-align:right;font-size:10px;font-weight:800;color:#6b7280;">GST</th>
                    <th style="padding:8px 12px;text-align:right;font-size:10px;font-weight:800;color:#6b7280;">Amount</th>
                </tr>
            </thead>
        ...
        <div style="display:flex;justify-content:flex-end;margin-bottom:14px;">
            <table style="width:320px;border-collapse:collapse;">
                ...
                ${totalTax > 0 ? `<tr><td style="padding:5px 12px;font-size:12px;color:#6b7280;">Total GST</td><td style="padding:5px 12px;font-size:12px;text-align:right;">${totalTax.toLocaleString('en-IN', { style: 'currency', currency: 'INR' })}</td></tr>` : ''}
