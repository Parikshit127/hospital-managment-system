...
.hn{font-size:24px;font-weight:bold}
.ft{font-size:13px;letter-spacing:4px;text-transform:uppercase;color:#666;margin-top:4px}
...
.sec-t{font-size:11px;font-weight:bold;text-transform:uppercase;color:#555;letter-spacing:2px;margin-bottom:10px}
.id-box{display:inline-block;background:#f8f8f8;border:2px solid #333;padding:6px 18px;font-size:20px;font-weight:bold;font-family:monospace;letter-spacing:3px;margin-bottom:14px}
...
<body>
<div class="hdr"><div class="hn">${hospitalName}</div><div class="ft">Patient Admission Facesheet</div></div>
<div>
