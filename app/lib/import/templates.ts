...
const serviceMasterColumns: ImportColumn[] = [
    ...
    { name: 'service_category', required: true, type: 'enum', description: 'Category', example: 'ICU', values: ['OPD Consultation', 'ICU', 'Procedure', 'Room', 'Nursing', 'Diet', 'Consumable', 'Home Care', 'Visit Charges', 'Misc'] },
