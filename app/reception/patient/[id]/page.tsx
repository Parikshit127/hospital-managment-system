...
import { getPatientDetail } from '@/app/actions/reception-actions';
...
export default function PatientProfilePage() {
    ...
    const [activeTab, setActiveTab] = useState<'overview' | 'appointments' | 'triage' | 'vitals'>('overview');
            ...
            <div className="space-y-6">
                ...
                <div className="bg-white border border-gray-200 shadow-sm rounded-2xl p-6">
                    <div className="flex flex-col md:flex-row md:items-center gap-6">
                        <div className="w-20 h-20 bg-gradient-to-br from-teal-500 to-emerald-600 rounded-2xl flex items-center justify-center text-white text-2xl font-black shadow-lg shadow-teal-500/20">
                        ...
                        <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                <span className="text-[10px] font-semibold text-gray-400 uppercase">Age / Gender</span>
                            ...
                            <div>
                                <span className="text-[10px] font-semibold text-gray-400 uppercase">Address</span>
                                <p className="text-sm text-gray-900 flex items-center gap-1">
                                    <MapPin className="h-3 w-3 text-gray-400" /> {patient.address || '-'}
                                </p>
                            </div>
                            <div>
                                <span className="text-[10px] font-semibold text-gray-400 uppercase">Blood Group</span>
                                <p className="text-sm text-gray-900">{patient.blood_group || '-'}</p>
                            </div>
                            <div>
                                <span className="text-[10px] font-semibold text-gray-400 uppercase">Registered</span>
                            ...
                            {data.appointments?.[0] ? (
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-gray-400">
                                        {new Date(data.appointments[0].appointment_date).toLocaleDateString('en-IN', { day: '2-digit', month: 'short', year: 'numeric' })}
                                    </p>
