                    ...
                    {loading && !stats ? (
                        ...
                        <>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                <Link href="/admin/pharmacy/orders" className="bg-white border border-gray-200 shadow-sm rounded-2xl p-5 hover:border-amber-300 transition-all">
                                ...
                                <Link href="/admin/pharmacy/inventory" className="bg-white border border-gray-200 shadow-sm rounded-2xl p-5 hover:border-red-300 transition-all">
                                    <div className="flex items-center justify-between mb-2">
                                ...
                                <Link href="/admin/pharmacy/returns" className="bg-white border border-gray-200 shadow-sm rounded-2xl p-5 hover:border-blue-300 transition-all">
                                    <div className="flex items-center justify-between mb-2">
                                ...
                                <Link href="/admin/pharmacy/reports" className="bg-white border border-gray-200 shadow-sm rounded-2xl p-5 hover:border-emerald-300 transition-all">
                                    <div className="flex items-center justify-between mb-2">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <Link
                                        href="/admin/pharmacy/purchase-orders"
