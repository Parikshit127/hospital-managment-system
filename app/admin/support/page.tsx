...
import { 
    getAllTickets, updateTicketStatus, getAssignableUsers, assignTicket,
    createTicketNote, getTicketNotes 
    ...
    const handleAssignTicket = async (ticketId: string, developerId: string | null) => {
        ...
        try {
            ...
            if (res.success && res.data) {
                ...
                triggerNotification('error', res.error || 'Failed to assign ticket');
            }
        } catch (error) {
